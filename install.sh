...
# NOTE: This install requires symlink gcc-5 after installation before update,
# which later will need to force overwrite the symlink on gcc  and gfortran
...
(
  ...
  # NOTE: No update for now
  # execute "${HOMEBREW_PREFIX}/bin/brew" "update" "--force" "--env=std"
) || exit 1
